// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetCampaignReportDataActivityFixture.cs" company="Rare Crowds Inc">
...
{
    /// <summary>Unit test fixture for GetCampaignReportDataActivity.</summary>
    [TestClass]
    public class GetCampaignReportDataActivityFixture
    {
        /// <summary>The activity under test</summary>
        private GetCampaignReportDataActivity activity;
        ...
        public void InitializeTest()
        {
            ...
            this.activity = Activity.CreateActivity(
                    ...
                    ActivityTestHelpers.SubmitActivityRequest) as GetCampaignReportDataActivity;
        }
