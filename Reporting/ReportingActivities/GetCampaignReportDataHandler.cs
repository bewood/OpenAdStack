// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetCampaignReportDataHandler.cs" company="Rare Crowds Inc">
...
{
    /// <summary>Class to get report data for a specified report on a campaign.</summary>
    public class GetCampaignReportDataHandler : IActivityHandler
    {
        /// <summary>Initializes a new instance of the <see cref="GetCampaignReportDataHandler"/> class.</summary>
        ...
        /// <param name="reportEntityId">Report entity id.</param>
        public GetCampaignReportDataHandler(IEntityRepository repository, EntityId companyEntityId, EntityId campaignEntityId, EntityId reportEntityId)
        {
        ...
        public IDictionary<string, string> Execute()
        {
            ...
            var reportEntity = this.Repository.GetEntity<ReportEntity>(context, this.ReportEntityId);
            return new Dictionary<string, string> { { ReportingActivityValues.ReportData, reportEntity.ReportData } };
        }
    }
}
