// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetCampaignReportDataActivity.cs" company="Rare Crowds Inc">
...
namespace ReportingActivities
{
    ...
    /// </summary>
    [Name(ReportingActivityTasks.GetCampaignReportData)]
    [RequiredValues(
        EntityActivityValues.CompanyEntityId, 
        EntityActivityValues.CampaignEntityId,
        EntityActivityValues.EntityId)]
    public class GetCampaignReportDataActivity : EntityActivity
    {
