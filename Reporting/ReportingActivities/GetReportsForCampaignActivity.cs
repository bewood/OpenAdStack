// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetReportsForCampaignActivity.cs" company="Rare Crowds Inc">
...
{
    /// <summary>
    /// Activity to get reports for a campaign.
    /// </summary>
    [Name(ReportingActivityTasks.GetReportsForCampaign)]
    [RequiredValues(
        EntityActivityValues.CompanyEntityId, 
        EntityActivityValues.CampaignEntityId)]
    public class GetReportsForCampaignActivity : EntityActivity
    {
