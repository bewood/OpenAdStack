// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Entity.cs" company="Rare Crowds Inc">
...
{
    /// <summary>
    /// A generalized Entity to hold data begin deserialized from the data store with a late-bound schema.
    /// No entity-type validation at this level. This entity may be wrapped by an EntityWrapperBase derived
    /// entity type.
    /// </summary>
