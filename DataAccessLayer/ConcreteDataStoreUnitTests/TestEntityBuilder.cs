...
namespace ConcreteDataStoreUnitTests
{
    ...
    public static class TestEntityBuilder
    {
        ...
        /// <summary>Helper method to build a blob entity.</summary>
        /// <returns>A BlobEntity.</returns>
        public static BlobEntity BuildBlobEntity()
        {
            return BuildBlobEntity(new EntityId());
        }

        /// <summary>Helper method to build a blob entity.</summary>
        /// <param name="externalEntityId">Entity Id</param>
        /// <returns>A BlobEntity.</returns>
        public static BlobEntity BuildBlobEntity(EntityId externalEntityId)
        {
            return new BlobEntity(
                new Entity
                {
                    ExternalEntityId = externalEntityId,
                    EntityCategory = BlobEntity.CategoryName,
                    ExternalName = "MyFooThingy",
                    ExternalType = "FooThingy"
                });
        }
