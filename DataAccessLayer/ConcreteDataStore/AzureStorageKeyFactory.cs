// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AzureStorageKeyFactory.cs" company="Rare Crowds Inc">
...
namespace ConcreteDataStore
{
    ...
    internal class AzureStorageKeyFactory : IStorageKeyFactory
    {
        ...
        public IStorageKey BuildNewStorageKey(string storageAccountName, EntityId companyExternalId, IEntity rawEntity)
        {
            ...
            if ((string)rawEntity.EntityCategory == CompanyEntity.CategoryName)
            {
        ...
        private string GetPartition(IEntity rawEntity)
        {
