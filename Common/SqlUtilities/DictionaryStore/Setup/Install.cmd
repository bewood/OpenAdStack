...
:: Run user scripts
::::::::::::::::::::::::::::::
for %%S in (%USERSCRIPTFILES%) do sqlcmd -d %DATABASE% %SQLCOMMANDPARAMS%  -i %%S 

::::::::::::::::::::::::::::::
:: Run table scripts
::::::::::::::::::::::::::::::
for %%S in (%TABLESCRIPTFILES%) do sqlcmd -d %DATABASE% %SQLCOMMANDPARAMS% -i %%S 

::::::::::::::::::::::::::::::
:: Run stored procedure scripts
::::::::::::::::::::::::::::::
for %%S in (%SPSCRIPTFILES%) do sqlcmd -d %DATABASE% %SQLCOMMANDPARAMS% -i %%S 

::::::::::::::::::::::::::::::
:: Run static data scripts
::::::::::::::::::::::::::::::
for %%S in (%STATICDATASCRIPTFILES%) do sqlcmd -d %DATABASE% %SQLCOMMANDPARAMS% -i %%S 
